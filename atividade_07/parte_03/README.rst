...
1. O número de itens disponíveis pode se tornar negativo?
    ...
    Não, o semáforo que controla a quantidade de itens disponíveis impede que a *thread* consumidora execute quando não houver itens para consumir. Dessa forma, o valor de ``count`` não pode se tornar negativo.
